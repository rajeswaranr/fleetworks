...
const CHECKS = {
  ...
  "Bare <button> (no .btn / .link-btn / framework class)": (t) =>
    [...t.matchAll(/<button\b([^>]*)>/g)].filter((m) => !/class\s*=\s*["'][^"']*(btn|link-btn|tab-btn|side-|settings-tile|fw-|chip|pill|toggle|close|nav|qa-|hub|drv-|role|cp-|mk-|ai-|fv-|fx-|gp-)/.test(m[1])).length,
