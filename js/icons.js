...
(function () {
  ...
  const P = {
    ...
    home: '<path d="M3 10l9-7 9 7v11a1 1 0 0 1-1 1h-4v-6h-8v6H4a1 1 0 0 1-1-1V10Z"/><path d="M9 21v-5h6v5"/>',
    dashboard: '<path d="M3 4h8v8H3V4Zm10 0h8v8h-8V4ZM3 14h8v8H3v-8Zm10 0h8v8h-8v-8Z"/>',
    overview: '<path d="M3 4h8v8H3V4Zm10 0h8v8h-8V4ZM3 14h8v8H3v-8Zm10 0h8v8h-8v-8Z"/>',
    fleet: '<path d="M2 17V6a1 1 0 0 1 1-1h11v12"/><path d="M14 9h4l3 3v5h-3"/><circle cx="7.5" cy="17.5" r="2"/><circle cx="17.5" cy="17.5" r="2"/><path d="M9.5 17.5h6"/>',
    ...
    vehicle: '<path d="M2 17V6a1 1 0 0 1 1-1h11v12"/><path d="M14 9h4l3 3v5h-3"/><circle cx="7.5" cy="17.5" r="2"/><circle cx="17.5" cy="17.5" r="2"/><path d="M9.5 17.5h6"/>',
    vehicles: '<path d="M2 17V6a1 1 0 0 1 1-1h11v12"/><path d="M14 9h4l3 3v5h-3"/><circle cx="7.5" cy="17.5" r="2"/><circle cx="17.5" cy="17.5" r="2"/><path d="M9.5 17.5h6"/>',
    ...
    copilot: '<path d="M9 4a2.5 2.5 0 0 0-2.5 2.5A2.5 2.5 0 0 0 5 11a2.5 2.5 0 0 0 1 4.5A2.5 2.5 0 0 0 9 20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2Z"/><path d="M15 4a2.5 2.5 0 0 1 2.5 2.5A2.5 2.5 0 0 1 19 11a2.5 2.5 0 0 1-1 4.5A2.5 2.5 0 0 1 15 20a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z"/>',
    foresight: '<path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/>',
    ...
    compliance: '<path d="M12 3 2 20h20L12 3Z"/><path d="M12 10v4M12 17.5v.5"/>',
    safety: '<path d="M12 3 5 6v6c0 4 3 6.5 7 8 4-1.5 7-4 7-8V6l-7-3Z"/><path d="m9.5 12 1.8 1.8L15 10"/>',
    maintenance: '<path d="M14.5 5.5a4 4 0 0 0-5.4 5l-6 6 2.4 2.4 6-6a4 4 0 0 0 5-5.4l-2.6 2.6-2-2 2.6-2.6Z"/>',
    team: '<circle cx="8" cy="9" r="3"/><circle cx="16" cy="9" r="3"/><path d="M4 20a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4"/>',
    people: '<circle cx="8" cy="9" r="3"/><circle cx="16" cy="9" r="3"/><path d="M4 20a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4"/>',
    users: '<circle cx="8" cy="9" r="3"/><circle cx="16" cy="9" r="3"/><path d="M4 20a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4"/>',
    reports: '<path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8Z"/><path d="M14 3v5h5"/><path d="M9 13h6M9 17h6"/>',
    marketplace: '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 10h18M9 10v11M15 10v11"/>',
    ...
    camera: '<path d="M3 8a2 2 0 0 1 2-2h2.5l1.3-2h6.4l1.3 2H19a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z"/><circle cx="12" cy="12.5" r="3.5"/>',
    ...
    chat: '<path d="M21 11.5a8.4 8.4 0 0 1-8.5 8.4 8.6 8.6 0 0 1-4-1L3 20l1.1-5.4a8.4 8.4 0 0 1-1-4A8.4 8.4 0 0 1 12.5 3 8.4 8.4 0 0 1 21 11.5Z"/>',
